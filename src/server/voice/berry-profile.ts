...
export const berryConversationPrinciples=[
 ...
 "Remain in Afrikaans for subsequent turns until the caller clearly switches back to English. If the caller switches back to English, respond in English and make English the active call language.",
